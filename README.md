...
# 🎮 Brigador Killers — Community Edition

**Isometric vehicle combat in the dystopian city of Solo Nobre.**
...
Brigador Killers is an isometric tactical action game set in the retro-futuristic dystopian city of Solo Nobre. Pilot an arsenal of mechs, tanks, and hovercraft through fully destructible urban battlefields. This Community Edition is a self-contained package that runs entirely offline with no storefront required.

This Community Edition is intended for players who want a complete, offline, self-contained release of Brigador Killers on Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/903930/64af2e9373b79309d34379f9a5203c78e3568816/ss_64af2e9373b79309d34379f9a5203c78e3568816.1920x1080.jpg?t=1787262286" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/903930/bf1c32f499df471bfc62d25e88067a73ce84e172/ss_bf1c32f499df471bfc62d25e88067a73ce84e172.1920x1080.jpg?t=1787262286" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/903930/44642eb0c6813186df41f9356386079e6ae7ca33/ss_44642eb0c6813186df41f9356386079e6ae7ca33.1920x1080.jpg?t=1787262286" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam, GOG / itch.io account required**
...
- 🚛 **Vehicle Arsenal** — Command mechs, tanks, hovercraft, and walkers, each with distinct handling and firepower.
- 💥 **Destructible Environments** — Reduce buildings, cover, and terrain to rubble as you carve a path through the city.
- 🎯 **Isometric Tactical Combat** — Twin-stick action from a detailed isometric perspective with emergent destruction.
- 🎨 **Retro-Futuristic Art Style** — Hand-crafted 2D sprites rendered against fully explorable 2.5D cityscapes.
- 🛠️ **Loadout Customization** — Equip weapons, turrets, and support systems to suit any approach.
- 🔊 **Original Soundtrack** — A dedicated electronic score composed for the Solo Nobre universe.
- 🏙️ **Campaign Across Solo Nobre** — Fight through districts of a brutalist sci-fi metropolis under occupation.
- 🕹️ **Precise Controls** — Full keyboard and gamepad support tuned for fast, deliberate engagements.
- 📦 **Complete Package** — This standalone build includes all content in a single self-contained install.

- **Compression:** Lossless
- **Install Time:** ~3 minutes on SSD, ~8 minutes on HDD
- **Recoding:** none
- **Selective Download:** None — complete self-contained package
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 11 compatible GPU with 1 GB VRAM | DirectX 11 compatible GPU with 2 GB VRAM |
| **Storage** | 3 GB available space | 3 GB available space on SSD |
| **Additional** | DirectX 11 | Solid state drive, gamepad supported |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\BrigadorKillers\Saved`
